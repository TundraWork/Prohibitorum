 ...
 * (built links only for Spec 2a). Application management is available to every
 * signed-in account; global administration remains strictly admin-only.
 */
import { computed } from 'vue'
import { useI18n } from 'vue-i18n'
import { useRoute } from 'vue-router'
import { ShieldCheck, MonitorSmartphone, KeyRound, Link2, TabletSmartphone, Users, Ticket, AppWindow, Building2, Network, KeySquare, ScrollText, Settings, Waypoints, LayoutGrid, Terminal, UserRoundCheck } from 'lucide-vue-next'
...
const adminItems = computed(() => [
  ...
  { to: '/admin/groups', label: t('admin.nav.groups'), icon: UserRoundCheck },
