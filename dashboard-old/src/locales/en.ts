...
export default {
  ...
  manage: {
    applications: {
      ...
      detailSubtitle: 'Manage protocol settings, assigned accounts, and who can sign in.',
    ...
    policy: {
      manual: {
        ...
        neutral: 'No related users',
        allowExplanation: 'Manual allow grants access. Matching calculated groups still appear in downstream claims.',
        denyExplanation: 'Manual deny takes precedence. No token or assertion is issued.',
        user: 'User',
        username: 'Username',
        addedAt: 'Added',
        addTitle: 'Add an account',
        addDescription: 'Search active accounts. Disabled accounts and accounts with an existing decision are excluded.',
        setAllowLabel: 'Allow {name}',
        setDenyLabel: 'Deny {name}',
        addAllow: 'Add to allow',
        addDeny: 'Add to deny',
        searchAction: 'Search',
        searching: 'Searching accounts…',
        searchPrompt: 'Search the account directory to add a user.',
        clear: 'Clear',
  ...
  admin: {
    ...
    account: {
      ...
      roleDesc: 'Users can manage applications assigned to them. Admins also manage the directory and settings.',
  ...
  "errors": {
    ...
    appManagers: {
      ...
      description: "Assign any active account to manage this application's configuration and access policy.",
      assigned: 'Accounts with access',
      assignedAt: 'Assigned',
      loading: 'Loading assigned accounts…',
      noneAssigned: 'No accounts assigned',
      noneAssignedDescription: 'Search the account directory below to assign an account.',
      retry: 'Retry loading assigned accounts',
      search: 'Assign an account',
      searchDescription: 'Search active accounts. Disabled and already assigned accounts are excluded.',
      searchLabel: 'Search accounts',
      searchPlaceholder: 'Search by name or username',
      searchAction: 'Search',
      searching: 'Searching accounts…',
      noResults: 'No available accounts match this search.',
      searchPrompt: 'Search the account directory to find an account.',
      assign: 'Assign',
      assignAccount: 'Assign {name} to this application',
      remove: 'Remove',
      removeAccount: 'Remove {name} from this application',
    },
    access: {
      title: 'App access',
