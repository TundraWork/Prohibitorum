...
export default {
  ...
  setupSignin: {
    ...
    intro: 'Your account currently signs in through your identity provider. You can also set a password or an authenticator app, so you can sign in even when the provider is unavailable — or skip this for now.',
    choosePassword: 'Set a password',
    chooseTotp: 'Set up an authenticator app',
    passwordDone: 'Password set.',
    totpDone: 'Authenticator app set.',
    skip: 'Skip for now',
    ...
    totpCodeLabel: 'Authenticator code',
    verify: 'Verify',
    totpVerified: 'Authenticator app set. Save the recovery codes below.',
    finish: 'Done',
  },
