...
export default {
  ...
  federationFlow: {
    ...
    identifyIntro: 'Enter the user ID from your VRChat profile or paste its full URL.',
    identityLabel: 'VRChat user ID or profile URL',
    identityExample: 'Example: usr_12345678-1234-1234-1234-123456789abc',
    prepare: 'Continue',
    ...
    usernameLabel: 'Local username',
    usernameDescription: 'Choose the username you will use in Prohibitorum.',
    usernamePlaceholder: 'e.g. alex',
