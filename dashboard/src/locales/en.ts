...
export default {
  ...
  admin: {
    ...
    saml: {
      ...
      nameIdClaim: 'NameID claim', attributeMap: 'Attribute map (JSON)',
    ...
    upstream: {
      ...
      disabledDesc: 'Hides this provider from the sign-in screen and blocks new logins and links. Accounts already linked can still sign in.',
