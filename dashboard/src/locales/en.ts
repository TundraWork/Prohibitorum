...
export default {
  ...
  admin: {
    ...
    saml: {
      ...
      sessionLifetimeDesc: 'Session-expiry hint (SessionNotOnOrAfter) in the assertion. Default 8 hours.',
    ...
    upstream: {
      ...
      scopesDesc: 'Scopes requested from the provider. Default: openid, email, profile.',
      disabled: 'Disabled',
      active: 'Active',
