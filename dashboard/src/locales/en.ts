...
export default {
  ...
  manage: {
    ...
    applications: {
      ...
      detailSubtitle: 'Manage who can sign in. Protocol configuration remains with administrators.',
  ...
  admin: {
    nav: { title: 'Admin', accounts: 'Accounts', invitations: 'Invitations', oidcApplications: 'OIDC applications', samlApplications: 'SAML applications', forwardAuthApps: 'Forward auth', identityProviders: 'Identity providers', signingKeys: 'Signing keys', audit: 'Audit log', federation: 'Federation', applications: 'Applications', settings: 'Settings' },
    accounts: {
      title: 'Accounts',
      invite: 'Invite',
