...
export default {
  ...
  admin: {
    ...
    account: {
      ...
      disabledDesc: 'Block sign-in and revoke access for this account.',
    ...
    oidc: {
      ...
      publicClientDesc: 'No client secret; for SPAs and native apps using PKCE.',
      requireConsentDesc: 'Show the consent screen on every authorization.',
      disabledDesc: 'Reject new authorization requests for this application.',
    ...
    saml: {
      ...
      wantAssertionsSignedDesc: 'Sign the assertions we send to this application.',
      allowIdpInitiatedDesc: 'Permit logins started from here, without an AuthnRequest.',
    ...
    upstream: {
      ...
      modeAutoProvisionDesc: 'Create a new account on first sign-in.',
      modeInviteOnlyDesc: 'Only redeem a matching invitation; never auto-create.',
      modeLinkOnlyDesc: 'Only sign in accounts already linked to this provider.',
      scopes: 'Scopes',
      scopesHint: 'Type a scope and press Enter. Paste a list to add several.',
      allowedDomains: 'Allowed email domains',
      domainsHint: 'Leave empty to allow any domain.',
      ...
      requireVerifiedEmailDesc: 'Only provision accounts whose email the provider marked verified.',
      disabledDesc: 'Stop offering this provider for sign-in or linking.',
