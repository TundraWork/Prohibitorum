...
export default {
  ...
  admin: {
    ...
    oidc: {
      ...
      urisHint: 'Type a URI and press Enter. Paste a list to add several.',
      uriInvalid: 'Each redirect URI must be an absolute URL.',
    ...
    upstream: {
      ...
      domainsHint: 'Type a domain and press Enter. Leave empty to allow any.',
