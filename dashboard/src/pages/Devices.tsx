            ...
            >
              ...
              <Description>
                <Trans id="devices.code.hint">
                  Pairing codes are short-lived. If yours has expired, generate
                  a new one on that device.
                </Trans>
              </Description>
              ...
              <SurfaceAlert.Content>
                <SurfaceAlert.Title>
                  <Trans id="devices.approved">
                    You approved this device. It still has to set up a passkey
                    on itself before the sign-in finishes.
                  </Trans>
                </SurfaceAlert.Title>
              </SurfaceAlert.Content>
            </SurfaceAlert>
            ...
            <div className="flex flex-col gap-4">
              ...
              <dl className="grid min-w-0 gap-4 sm:grid-cols-2">
                <div className="min-w-0">
                  ...
                  <dd className="wrap-anywhere font-mono">
                    {found.displayCode}
                  </dd>
                </div>
                <div className="min-w-0">
